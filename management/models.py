...
# 获取S1阶段数据
class S1Data(db.Model):
    __tablename__ = 's1-data'
    openid = db.Column(db.String(60), primary_key=True)
    # first_section=db.Column(db.String(15))
    # 供应商数据
    gys_supplier = db.Column(db.String(50))
    gys_logisticsWeek = db.Column(db.String(50))
    gys_size = db.Column(db.Integer)



    # 客户数据
    kh_totalMonth = db.Column(db.Integer)
    kh_totalLeft = db.Column(db.Integer)
    kh_totalRight = db.Column(db.Integer)
    kh_huoPan = db.Column(db.Integer)
    kh_banCi = db.Column(db.Integer)

    # 冲压工序数据
    cy_cycleTime = db.Column(db.Integer)
    cy_SMEDTime = db.Column(db.Integer)
    cy_upTime = db.Column(db.Integer)
    cy_Operators = db.Column(db.Integer)
    cy_EPE = db.Column(db.Integer)
    cy_runningTime = db.Column(db.Integer)
    cy_Wip = db.Column(db.Integer)
    cy_valueTime = db.Column(db.Integer)
    # 机加工工序数据
    jjg_cycleTime = db.Column(db.Integer)
    jjg_SMEDTime = db.Column(db.Integer)
    jjg_upTime = db.Column(db.Integer)
    jjg_Operators = db.Column(db.Integer)
    jjg_Banci = db.Column(db.Integer)
    jjg_runningTime = db.Column(db.Integer)
    jjg_WipLeft = db.Column(db.Integer)
    jjg_WipRight = db.Column(db.Integer)
    jjg_valueTime = db.Column(db.Integer)
    # 焊接工序数据
    hj_cycleTime = db.Column(db.Integer)
    hj_SMEDTime = db.Column(db.Integer)
    hj_upTime = db.Column(db.Integer)
    hj_Operators = db.Column(db.Integer)
    hj_Banci = db.Column(db.Integer)
    hj_runningTime = db.Column(db.Integer)
    hj_WipLeft = db.Column(db.Integer)
    hj_WipRight = db.Column(db.Integer)
    hj_valueTime = db.Column(db.Integer)
    # 装配1工序数据
    zp1_cycleTime = db.Column(db.Integer)
    zp1_SMEDTime = db.Column(db.Integer)
    zp1_upTime = db.Column(db.Integer)
    zp1_Operators = db.Column(db.Integer)
    zp1_Banci = db.Column(db.Integer)
    zp1_runningTime = db.Column(db.Integer)
    zp1_WipLeft = db.Column(db.Integer)
    zp1_WipRight = db.Column(db.Integer)
    zp1_valueTime = db.Column(db.Integer)
    # 装配2工序数据
    zp2_cycleTime = db.Column(db.Integer)
    zp2_SMEDTime = db.Column(db.Integer)
    zp2_upTime = db.Column(db.Integer)
    zp2_Operators = db.Column(db.Integer)
    zp2_Banci = db.Column(db.Integer)
    zp2_runningTime = db.Column(db.Integer)
    zp2_WipLeft = db.Column(db.Integer)
    zp2_WipRight = db.Column(db.Integer)
    zp2_valueTime = db.Column(db.Integer)
    # 发运工序数据
    fy_WipLeft = db.Column(db.Integer)
    fy_WipRight = db.Column(db.Integer)
    ...
    def jsonstr(self):
        jsonstr = {
            ...
            "cy_SMEDTime": self.cy_SMEDTime,
            "cy_upTime": self.cy_upTime,
            "cy_Operators": self.cy_Operators,
            "cy_EPE": self.cy_EPE,
            "cy_runningTime": self.cy_runningTime,
            "cy_Wip": self.cy_Wip,
            "cy_valueTime": self.cy_valueTime,
        }
        return jsonstr

# 获取S1阶段数据
class S4Data(db.Model):
    __tablename__ = 's4-data'
    openid = db.Column(db.String(60), primary_key=True)
    # first_section=db.Column(db.String(15))
    # 供应商数据
    gys_supplier = db.Column(db.String(50))
    ...
    # 流水线工序数据
    lsx_cycleTime = db.Column(db.Integer)
    lsx_SMEDTime = db.Column(db.Integer)
    lsx_upTime = db.Column(db.Integer)
    lsx_Operators = db.Column(db.Integer)
    lsx_Banci = db.Column(db.Integer)
    lsx_runningTime = db.Column(db.Integer)
    lsx_WipLeft = db.Column(db.Integer)
    lsx_WipRight = db.Column(db.Integer)
    lsx_valueTime = db.Column(db.Integer)
    # 发运工序数据
    fy_WipLeft = db.Column(db.Integer)
    fy_WipRight = db.Column(db.Integer)
